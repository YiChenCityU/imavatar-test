...
class GeometryNetwork(nn.Module):
    def __init__(
        ...
        if multires > 0:
            ...
            # embed_fn = GridEncoder(input_dim=3, num_levels=3, level_dim=2, base_resolution=16, log2_hashmap_size=19, desired_resolution=1024, gridtype='hash', align_corners=True)
