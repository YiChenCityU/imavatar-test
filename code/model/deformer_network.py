...
class ForwardDeformer(nn.Module):
    def __init__(self,
        ...
        if multires > 0:
            ...
            # embed_fn = GridEncoder(input_dim=3, num_levels=16, level_dim=2, base_resolution=16, log2_hashmap_size=19, desired_resolution=2048, gridtype='hash', align_corners=False)
            # input_ch = embed_fn.output_dim
