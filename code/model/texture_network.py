...
class RenderingNetwork(nn.Module):
    def __init__(
        ...
        if multires_pnts > 0:
            ...
            # embedpnts_fn = GridEncoder(input_dim=3, num_levels=16, level_dim=2, base_resolution=16, log2_hashmap_size=19, desired_resolution=2048, gridtype='hash', align_corners=False)
            # input_ch_pnts = embedpnts_fn.output_dim
